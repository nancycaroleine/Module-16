...
## OUTPUT
![image](https://github.com/user-attachments/assets/35bfd819-ec55-4416-8518-8fa97810c690)
## RESULT
Thus , a Python function `def leftRotate(self, z):` to perform the left rotation operation in an AVL Tree and insert the element '7' into it are verified.
