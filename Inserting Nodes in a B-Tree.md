...
## OUTPUT
![image](https://github.com/user-attachments/assets/4e908c09-07d9-41e9-a862-617860136e2f)
## RESULT
Thus, a Python function `def insert(self, k):` to insert the nodes in a **B-Tree** are verified.
